...
@Component({
  selector: 'app-corredornebuloso',
  templateUrl: './corredornebuloso.page.html',
  styleUrls: ['./corredornebuloso.page.scss'],
})
export class CorredornebulosoPage implements OnInit {
