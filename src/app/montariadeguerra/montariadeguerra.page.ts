...
@Component({
  selector: 'app-montariadeguerra',
  templateUrl: './montariadeguerra.page.html',
  styleUrls: ['./montariadeguerra.page.scss'],
})
export class MontariadeguerraPage implements OnInit {
